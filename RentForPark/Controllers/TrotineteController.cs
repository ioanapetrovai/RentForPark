...
{
    public class TrotineteController : Controller
    {
        ...
        // GET: Trotinete/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Trotinete/Create
